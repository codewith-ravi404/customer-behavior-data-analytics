...
-- Q2. which customer used a discount  but still spent  more than the avg purchase amout?
...
-- Q5. Do subscribe customer spend more? compare avg spend and total revenue between subscribes and non-subscribers.
...
-- Q8. what are the top 3 most puschased products within each category?
with item_counts as (
select category,
item_purchased,
